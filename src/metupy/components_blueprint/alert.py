class Alert:
    ...
    def __str__(self):
        ...
        themes = {
            "info": {"bg": "rgba(59, 130, 246, 0.1)", "border": "#3b82f6", "color": "#1d4ed8"},
            "success": {"bg": "rgba(34, 197, 94, 0.1)", "border": "#22c55e", "color": "#15803d"},
            "warning": {"bg": "rgba(245, 158, 11, 0.1)", "border": "#f59e0b", "color": "#b45309"},
            "danger": {"bg": "rgba(239, 68, 68, 0.1)", "border": "#ef4444", "color": "#b91c1c"}
        }
        ...
        title_html = f'<div style="font-weight: 700; margin-bottom: 0.25rem;">{self.title}</div>' if self.title else ''
        
        # FIX: Hapus semua spasi di awal baris pada string HTML ini
...
{title_html}
<div style="opacity: 0.9;">{self.message}</div>
</div>
</div>"""
